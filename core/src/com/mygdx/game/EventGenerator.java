...
public class EventGenerator {
    ...
    static {
        ...
        accessibilityEvents.add(new Event("It is 2:00 am and you still need to write the exam for tomorrow.",
                ...
                new Option("Use an old exam from a different professor.", "It turns out, all your students studied that professor's exam and they all got A+'s", new StatChange(Stat.EASINESS, 20))));
